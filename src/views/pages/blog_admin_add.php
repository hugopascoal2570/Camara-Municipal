...
<header>
    ...
    <section class="container main">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Adicionando Notícias</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="<?php echo $base; ?>/admin/blog_add" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Titulo da Noticia</label>
                  <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Informe a manchete da Notícia">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Sub-titulo da Notícia</label>
                  <input type="text" class="form-control" id="sub_titulo" name="sub_titulo" placeholder="Informe o sub titulo da notícia">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Autor da Postagem</label>
                  <input type="text" class="form-control" id="autor" name="autor" placeholder="Informe o Autor da postagem">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Categoria da Postagem</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="c_corpo" name="corpo" placeholder="Insira o texto da Notícia.">
                </div>
              ...
              <p style="color: red;">Atenção: só preencher o campo abaixo caso queria deixar a noticia destacadas nos seguintes campos </p>
                ...
                <div class="form-group">
                  ...
                  <input type="checkbox" name="noticia_lembrete" />
                </div>
...
tinymce.init({
  ...
  width:1000,
	...
	toolbar:'undo redo | formatselect | color | media image | bold italic backcolor | alignleft aligncenter alignright alignjustify | bullist numlist | removeformat'
});
</script>
</body>
</html>